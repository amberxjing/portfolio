export const categories = ["All", "AI native", "UI/UX", "Side work"];

export const projects = [
  {
    slug: "project-ai-product",
    title: "AI Product Design",
    category: "AI native",
    summary: "An AI product case study presented through the original project visuals.",
  ...
  {
    slug: "project-recharge-center",
    title: "Recharge Center Design",
    category: "UI/UX",
    summary: "A recharge-center product experience case study presented through the original project visuals.",
    role: "UX/UI Design / Product Experience",
    year: "2026",
    tone: "dark",
  ...
  },
  {
    ...
    title: "MBTI Test Design",
    category: "AI native",
    summary: "A personality test experience case study presented through the original project visuals.",
  ...
  {
    slug: "project-nas",
    title: "NAS Product Design",
    category: "Side work",
    summary: "A NAS product experience case study presented through the original project visuals.",
    role: "UX/UI Design / Product Experience",
    year: "2026",
    tone: "dark",
    cover: "nas",
    ...
    caseVideos: [
      {
        ...
        insertAfter: 0,
        variant: "phone",
        label: "Xunlei UX recording"
      },
      {
        src: new URL("../../asset/project/nas/正文/launch-motion.mp4", import.meta.url).href,
        insertAfter: 4,
        variant: "phone",
        label: "NAS launch page motion"
      }
    ],
    caseImages: [
  ...
  {
    slug: "project-algorithm-list",
    title: "Algorithm Topic List Redesign",
    category: "UI/UX",
    summary: "A topic-list redesign case study focused on improving design clarity and conversion.",
    role: "UX/UI Design / Conversion Optimization",
    year: "2026",
    tone: "paper",
    cover: "suanfa",
  ...
  {
    slug: "project-shopee",
    title: "Shopee Recharge Design",
    category: "Side work",
    summary: "A Shopee recharge experience case study presented through the original project visuals.",
    role: "UX/UI Design / Product Experience",
    year: "2026",
    tone: "paper",
    cover: "shopee",
  ...
  {
    slug: "project-plugin",
    title: "Plugin Tool Design",
    category: "AI native",
    summary: "A plugin-tool product experience case study presented through the original project visuals.",
    role: "UX/UI Design / Product Experience",
    year: "2026",
    tone: "dark",
    cover: "plugin",
  ...
  {
    slug: "project-qulin",
    title: "Qulin Product Design",
    category: "UI/UX",
    summary: "A product experience case study presented through the original Qulin project visuals.",
    role: "UX/UI Design / Product Experience",
    year: "2026",
    tone: "dark",
    cover: "qulin",
